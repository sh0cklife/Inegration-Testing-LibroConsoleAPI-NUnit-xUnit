...
namespace LibroConsoleAPI.IntegrationTests
{
    public class IntegrationTests : IClassFixture<BookManagerFixture>
    {
        ...
        //Positive Test
        [Fact]
        public async Task AddBookAsync_ShouldAddBook() // TASK = tova e responsa na otgovora ot bazata danni ?!:D
        {
            // Arrange
        ...
        public async Task AddBookAsync_TryToAddBookWithInvalidCredentials_ShouldThrowException()
        {
            ...
            var newBook = new Book
            {
                Title = new string('A', 500), //invalid title
                Author = "John Doe",
                ISBN = "1234567890123",
                YearPublished = 2021,
                Genre = "Fiction",
            ...
            // Act - assertvame v acta za da moje da produljim nadolu kum assert a ne appa da grumne
        ...
        public async Task AddBookAsync_TryToAddBookWithInvalidISBN_ShouldThrowException()
        {
            ...
            var newBook = new Book
            {
                Title = "Integration testing for beginners",
                Author = "John Doe",
                ISBN = "007",
                YearPublished = 2021,
                Genre = "Fiction",
